<template>
    <div>
        <el-row type="flex">
            <el-col :span="4">
                <div class="pageTitle">测试用例新建</div>
            </el-col>
            <el-col :offset="12" :span="2"  class="button-align">
        ...
        <div v-if="confirm == true">
          <span>
            <i class="el-icon-check" title="通过并启用" @click="confirmCase(caseId, '未执行')"></i>
            &nbsp;&nbsp;&nbsp;
            <i class="el-icon-close" title="不通过" @click="confirmCase(caseId, '未填写')"></i>
          </span>
        </div>
    </div>
</template>
